-- Migration v30 — Ajoute places_total au RETURNS de trajets_compatibles
-- Nécessaire pour afficher le badge live "X/total places" côté client.
