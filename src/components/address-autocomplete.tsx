    ...
    <div ref={wrapRef} className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-200 pl-9 pr-20 py-2.5 text-sm focus:border-slate-400 focus:outline-none"
        />
        {loading && (
          <Loader2 className="absolute right-12 top-1/2 -translate-y-1/2 size-4 text-slate-400 animate-spin" />
        )}
        <button
          type="button"
          ...
          className="absolute right-2 top-1/2 -translate-y-1/2 inline-flex size-7 items-center justify-center rounded-md text-slate-500 hover:bg-slate-100 hover:text-emerald-700 disabled:opacity-50 transition"
        >
          {locating ? (
