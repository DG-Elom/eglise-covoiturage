  ...
  return (
    <>
      <button
        type="button"
        onClick={open}
        className="inline-flex items-center gap-1 rounded-md border border-slate-200 px-2 py-1 text-[11px] text-slate-500 hover:border-red-200 hover:text-red-700 hover:bg-red-50 transition dark:border-slate-700 dark:hover:border-red-800 dark:hover:bg-red-950/40 dark:hover:text-red-300"
      >
      ...
      >
        <form onSubmit={submit} className="w-[min(440px,calc(100vw-32px))] p-5 space-y-4">
          ...
          <div>
            <label className="text-xs font-medium text-slate-700 dark:text-slate-300">Motif</label>
